...
scoreboard players set @s thallium.menu.active 0

tellraw @s [{translate:"ui.thallium.load.announce",color:"gray",font:"thallium:5",with:[[{text:"0 ",color:"white",font:"thallium:icon",click_event:{action:"run_command",command:"/trigger tl.menu set 82"}},{translate:"ui.thallium.title",color:"white",font:"thallium:tooltip"}],{"text":"1.3.0",color:"gray",font:"thallium:5"}]}]
tellraw @s ""
